...
> **Pacchetto sorgente:** `0.1.0` · build Docker/web · il profilo Compose predefinito è `public-readonly`, locale e read-only.
>
> **Immagine pubblicata:** `ghcr.io/markussela/poketokendocker:0.1.0` · Imposta `PTD_IMAGE` per usare Docker Hub o un tag locale.

## Informazioni sul progetto

PokeTokenDocker è la build web headless dell’idea PokeTokenBar: l’utilizzo locale dell’AI per il coding diventa un uovo, poi un companion e infine un Pokédex in crescita. È pensato per un server, un NAS o una macchina locale fidata dove un container Docker può leggere i metadati di utilizzo e servire il companion dal browser.
...
Le immagini sono state catturate dalla WebUI con una fixture sintetica isolata. Contengono soltanto valori dimostrativi e non mostrano il container live o un account personale. L’indice completo è in [`docs/SCREENSHOTS.md`](docs/SCREENSHOTS.md).

<table>
  <tr><td align="center"><img src="docs/images/home.png" alt="Workspace web PokeTokenDocker" width="520"></td><td><strong>🏠 Workspace.</strong><br>Home, Borsa, Negozio e Pokédex nella vista larga. Home riunisce companion, progressione, riepilogo utilizzo, provider, quote e avviso sui dati locali.</td></tr>
  <tr><td align="center"><img src="docs/images/home-panel.png" alt="Pannello Home PokeTokenDocker" width="360"></td><td><strong>📊 Home.</strong><br>Companion attivo, barra di progressione, wallet, totali giornalieri/settimanali, metriche provider, quote ufficiali e confine read-only.</td></tr>
  <tr><td align="center"><img src="docs/images/bag.png" alt="Borsa PokeTokenDocker" width="190"><img src="docs/images/shop.png" alt="Negozio PokeTokenDocker" width="190"></td><td><strong>🎒 Borsa e 🛍️ Negozio.</strong><br>La Borsa mostra l’inventario locale; il Negozio elenca oggetti e livelli di uovo. Nel profilo Docker predefinito i controlli sono visibili ma disabilitati.</td></tr>
  <tr><td align="center"><img src="docs/images/pokedex.png" alt="Pokédex PokeTokenDocker" width="230"><img src="docs/images/catch-log.png" alt="Registro catture PokeTokenDocker" width="230"></td><td><strong>📖 Pokédex e Registro catture.</strong><br>Le card usano sprite animati; il registro mostra catene evolutive, rarità, natura e date dimostrative neutrali.</td></tr>
  <tr><td align="center"><img src="docs/images/settings.png" alt="Impostazioni PokeTokenDocker" width="520"></td><td><strong>⚙️ Impostazioni.</strong><br>Lingua, refresh, privacy, cartelle read-only, backup, aggiornamenti e link di supporto in un unico dialogo.</td></tr>
  <tr><td align="center"><img src="docs/images/mini.png" alt="Vista Mini PokeTokenDocker" width="520"></td><td><strong>🧩 Vista Mini.</strong><br>Pagina compatta per Homepage o iframe fidati. Usa `PTD_EMBED_ORIGIN` per autorizzare una sola origine.</td></tr>
</table>
...
| --- | --- | --- |
| `PTD_IMAGE` | `ghcr.io/markussela/poketokendocker:0.1.0` | Riferimento all’immagine pubblicata; puoi sostituirlo con Docker Hub o un tag locale. |
